                ...
                <div class="modal-body mx-3">
                    ...
                    <div class="modal-body mx-3">
                        <div class="md-form mb-5">
                            ...
                            <input type="text" id="stars" class="form-control validate" name="stars" required
                        ...
                        <div class="modal-body mx-3">
                            <div class="md-form mb-5">
                                ...
                                <input type="text" id="room_available" class="form-control validate" name="room_available" required
